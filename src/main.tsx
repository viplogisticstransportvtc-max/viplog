  ...
  return (
    <div className="min-h-screen bg-[#080808] text-white">
      <header className="fixed top-0 z-50 w-full border-b border-white/10 bg-[#080808]/75 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-3 lg:px-8">
          ...
          <nav className="hidden items-center gap-1 xl:flex">
            ...
            <div className="nav-dropdown">
              <button className="nav-link nav-dropdown-trigger" type="button">VTC <ChevronDown size={13}/></button>
        ...
        {menuOpen && (
          <div className="mobile-nav border-t border-white/10 bg-[#0b0b0b] px-5 py-5 lg:hidden">
            <a href="#home" onClick={closeMenu} className="mobile-nav-link mobile-nav-link-active">HOME</a>
            <a href="#about-us" onClick={closeMenu} className="mobile-nav-link">ABOUT US</a>
